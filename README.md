## kobuki_core (noetic) - 0.7.12-1

The packages in the `kobuki_core` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --track noetic --rosdistro noetic kobuki_core` on `Wed, 16 Sep 2020 02:14:29 -0000`
...
## kobuki_core (melodic) - 0.7.12-1

The packages in the `kobuki_core` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --track melodic --rosdistro melodic kobuki_core` on `Wed, 16 Sep 2020 02:10:34 -0000`
...
## kobuki_core (melodic) - 0.7.11-1

The packages in the `kobuki_core` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --track melodic --rosdistro melodic kobuki_core` on `Wed, 16 Sep 2020 02:06:11 -0000`
...
## kobuki_core (kinetic) - 0.7.10-1

The packages in the `kobuki_core` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --track kinetic --rosdistro kinetic kobuki_core` on `Mon, 14 Sep 2020 01:54:53 -0000`
...
## kobuki_core (melodic) - 0.7.10-1

The packages in the `kobuki_core` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --track melodic --rosdistro melodic kobuki_core` on `Mon, 14 Sep 2020 01:45:36 -0000`
...
## kobuki_core (noetic) - 0.7.10-1

The packages in the `kobuki_core` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --track noetic --rosdistro noetic kobuki_core` on `Mon, 14 Sep 2020 01:27:39 -0000`
...
## kobuki_core (eloquent) - 0.8.0-2

The packages in the `kobuki_core` repository were released into the `eloquent` distro by running `/usr/bin/bloom-release --track eloquent --rosdistro eloquent kobuki_core` on `Thu, 09 Jan 2020 21:31:59 -0000`
...
The packages in the `kobuki_core` repository were released into the `indigo` distro by running `/usr/bin/bloom-release kobuki_core -t indigo -r indigo -n` on `Mon, 04 Aug 2014 12:45:45 -0000`
